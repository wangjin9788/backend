...
public final class PasswordStorage {
  ...
  public static boolean verifyPassword(final char[] password,
      final String correctHash)
      throws CannotPerformOperationException, InvalidHashException {
    ...
    final byte[] pbkdfHash = pbkdf2(password, salt, iterations, hash.length);
    // Compare the hashes in constant time. The password is correct if
    // both hashes match.
    return slowEquals(hash, pbkdfHash);
  }
