...
public class AppPage<T> implements Serializable {
   ...
   * @param currentpage
   */
  public AppPage(final Integer perpage, final Integer currentpage) {
    super();
  ...
  public boolean equals(final Object obj) {
    ...
    final AppPage other = (AppPage) obj;
  ...
  public AppPageModel<T> convertToAppPageModel() {
    return new AppPageModel<>(perpage, currentpage, totalcount, totalpage,
        data);
  }
}
